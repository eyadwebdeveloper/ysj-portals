...
<head>
    ...
    <title>Welcome | 2025 YSJ Senior Application</title>
...
<body>
    <div class="dashboard-container">
        ...
        <div class="control-head">
            <h2>2025 YSJ Senior Application</h2>
        </div>
        ...
        <p class="welcome">Welcome to the Senior Application for the 2025 season of the YSJ annual program! Get started by logging in to your account or creating a new one.</p>
        <div class="links">
            <a href="login">Login</a>
            <a href="register">Create account</a>
        </div>
